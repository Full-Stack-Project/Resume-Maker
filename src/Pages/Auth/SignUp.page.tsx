      ...
      <div className="px-10 sm:px-0 flex flex-col justify-center min-h-screen space-y-16 mx-auto max-w-26rem">
        <div className="space-y-3">
          ...
          <h5 className="text-sm font-bold">
            ...
            <LinkTo to="/login" className="border-b border-primary-medium">
              Log in
            </LinkTo>
          </h5>
        </div>
          ...
          <div>
            <div className="text-secondary-light space-x-3">
              ...
              <label htmlFor="termAgreement">
                I agree to the{" "}
                <LinkTo to="/termsandconditions">terms and conditions</LinkTo>
              </label>
            </div>
          </div>
          <div className="flex sm:flex:row space-y-8 sm:space-y-0 justify-between">
            <FormSwitch
